...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1067,            /* -m128bit-long-double */
  OPT_m16 = 1068,                            /* -m16 */
  OPT_m32 = 1069,                            /* -m32 */
  OPT_m3dnow = 1070,                         /* -m3dnow */
  OPT_m3dnowa = 1071,                        /* -m3dnowa */
  OPT_m64 = 1072,                            /* -m64 */
  OPT_m80387 = 1073,                         /* -m80387 */
  OPT_m8bit_idiv = 1074,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1075,             /* -m96bit-long-double */
  OPT_mabi_ = 1076,                          /* -mabi= */
  OPT_mabm = 1077,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1078,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1079,                 /* -maddress-mode= */
  OPT_madx = 1080,                           /* -madx */
  OPT_maes = 1081,                           /* -maes */
  OPT_malign_double = 1082,                  /* -malign-double */
  OPT_malign_functions_ = 1083,              /* -malign-functions= */
  OPT_malign_jumps_ = 1084,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1085,                  /* -malign-loops= */
  OPT_malign_stringops = 1086,               /* -malign-stringops */
  OPT_mandroid = 1087,                       /* -mandroid */
  OPT_march_ = 1088,                         /* -march= */
  OPT_masm_ = 1089,                          /* -masm= */
  OPT_mavx = 1090,                           /* -mavx */
  OPT_mavx2 = 1091,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1092,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1093,  /* -mavx256-split-unaligned-store */
  OPT_mavx512cd = 1094,                      /* -mavx512cd */
  OPT_mavx512er = 1095,                      /* -mavx512er */
  OPT_mavx512f = 1096,                       /* -mavx512f */
  OPT_mavx512pf = 1097,                      /* -mavx512pf */
  OPT_mbionic = 1098,                        /* -mbionic */
  OPT_mbmi = 1099,                           /* -mbmi */
  OPT_mbmi2 = 1100,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1101,                  /* -mbranch-cost= */
  OPT_mcld = 1102,                           /* -mcld */
  OPT_mcmodel_ = 1103,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1104, */                    /* -mcpu= */
  OPT_mcrc32 = 1105,                         /* -mcrc32 */
  OPT_mcx16 = 1106,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1107,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1108,            /* -mdump-tune-features */
  OPT_mf16c = 1109,                          /* -mf16c */
  OPT_mfancy_math_387 = 1110,                /* -mfancy-math-387 */
  OPT_mfentry = 1111,                        /* -mfentry */
  OPT_mfma = 1112,                           /* -mfma */
  OPT_mfma4 = 1113,                          /* -mfma4 */
  OPT_mforce_drap = 1114,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1115,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1116,                       /* -mfpmath= */
  OPT_mfsgsbase = 1117,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1118, */              /* -mfused-madd */
  OPT_mfxsr = 1119,                          /* -mfxsr */
  OPT_mglibc = 1120,                         /* -mglibc */
  OPT_mhard_float = 1121,                    /* -mhard-float */
  OPT_mhle = 1122,                           /* -mhle */
  OPT_mieee_fp = 1123,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1124,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1125,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1126,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1127, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1128,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1129,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1130,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1131,                /* -mlong-double-80 */
  OPT_mlwp = 1132,                           /* -mlwp */
  OPT_mlzcnt = 1133,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1134,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1135,              /* -mmemset-strategy= */
  OPT_mmmx = 1136,                           /* -mmmx */
  OPT_mmovbe = 1137,                         /* -mmovbe */
  OPT_mms_bitfields = 1138,                  /* -mms-bitfields */
  OPT_mmusl = 1139,                          /* -mmusl */
  OPT_mno_align_stringops = 1140,            /* -mno-align-stringops */
  OPT_mno_default = 1141,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1142,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1143,                  /* -mno-push-args */
  OPT_mno_red_zone = 1144,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1145,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1146,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1147,                          /* -mpc32 */
  OPT_mpc64 = 1148,                          /* -mpc64 */
  OPT_mpc80 = 1149,                          /* -mpc80 */
  OPT_mpclmul = 1150,                        /* -mpclmul */
  OPT_mpopcnt = 1151,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1152,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1153,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1154,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1155,                        /* -mprfchw */
  OPT_mpush_args = 1156,                     /* -mpush-args */
  OPT_mrdrnd = 1157,                         /* -mrdrnd */
  OPT_mrdseed = 1158,                        /* -mrdseed */
  OPT_mrecip = 1159,                         /* -mrecip */
  OPT_mrecip_ = 1160,                        /* -mrecip= */
  OPT_mred_zone = 1161,                      /* -mred-zone */
  OPT_mregparm_ = 1162,                      /* -mregparm= */
  OPT_mrtd = 1163,                           /* -mrtd */
  OPT_mrtm = 1164,                           /* -mrtm */
  OPT_msahf = 1165,                          /* -msahf */
  OPT_msha = 1166,                           /* -msha */
  OPT_msoft_float = 1167,                    /* -msoft-float */
  OPT_msse = 1168,                           /* -msse */
  OPT_msse2 = 1169,                          /* -msse2 */
  OPT_msse2avx = 1170,                       /* -msse2avx */
  OPT_msse3 = 1171,                          /* -msse3 */
  OPT_msse4 = 1172,                          /* -msse4 */
  OPT_msse4_1 = 1173,                        /* -msse4.1 */
  OPT_msse4_2 = 1174,                        /* -msse4.2 */
  OPT_msse4a = 1175,                         /* -msse4a */
  /* OPT_msse5 = 1176, */                    /* -msse5 */
  OPT_msseregparm = 1177,                    /* -msseregparm */
  OPT_mssse3 = 1178,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1179,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1180,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1181,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1182,            /* -mstringop-strategy= */
  OPT_mtbm = 1183,                           /* -mtbm */
  OPT_mtls_dialect_ = 1184,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1185,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1186,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1187,                         /* -mtune= */
  OPT_muclibc = 1188,                        /* -muclibc */
  OPT_mveclibabi_ = 1189,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1190,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1191,                    /* -mvzeroupper */
  OPT_mx32 = 1192,                           /* -mx32 */
  OPT_mxop = 1193,                           /* -mxop */
  OPT_mxsave = 1194,                         /* -mxsave */
  OPT_mxsaveopt = 1195,                      /* -mxsaveopt */
  OPT_n = 1196,                              /* -n */
  OPT_no_canonical_prefixes = 1197,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1198,              /* -no-integrated-cpp */
  OPT_nocpp = 1199,                          /* -nocpp */
  OPT_nodefaultlibs = 1200,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1201,                   /* -nostartfiles */
  OPT_nostdinc = 1202,                       /* -nostdinc */
  OPT_nostdinc__ = 1203,                     /* -nostdinc++ */
  OPT_nostdlib = 1204,                       /* -nostdlib */
  OPT_o = 1205,                              /* -o */
  OPT_p = 1206,                              /* -p */
  OPT_pass_exit_codes = 1207,                /* -pass-exit-codes */
  /* OPT_pedantic = 1208, */                 /* -pedantic */
  OPT_pedantic_errors = 1209,                /* -pedantic-errors */
  OPT_pg = 1210,                             /* -pg */
  OPT_pie = 1211,                            /* -pie */
  OPT_pipe = 1212,                           /* -pipe */
  OPT_posix = 1213,                          /* -posix */
  OPT_print_file_name_ = 1214,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1215,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1216,          /* -print-multi-directory */
  OPT_print_multi_lib = 1217,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1218,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1219,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1220,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1221,               /* -print-prog-name= */
  OPT_print_search_dirs = 1222,              /* -print-search-dirs */
  OPT_print_sysroot = 1223,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1224,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1225,                        /* -profile */
  OPT_pthread = 1226,                        /* -pthread */
  OPT_quiet = 1227,                          /* -quiet */
  OPT_r = 1228,                              /* -r */
  OPT_rdynamic = 1229,                       /* -rdynamic */
  OPT_remap = 1230,                          /* -remap */
  OPT_s = 1231,                              /* -s */
  OPT_s_bc_abi = 1232,                       /* -s-bc-abi */
  OPT_save_temps = 1233,                     /* -save-temps */
  OPT_save_temps_ = 1234,                    /* -save-temps= */
  OPT_shared = 1235,                         /* -shared */
  OPT_shared_libgcc = 1236,                  /* -shared-libgcc */
  /* OPT_specs = 1237, */                    /* -specs */
  OPT_specs_ = 1238,                         /* -specs= */
  OPT_static = 1239,                         /* -static */
  OPT_static_libasan = 1240,                 /* -static-libasan */
  OPT_static_libgcc = 1241,                  /* -static-libgcc */
  OPT_static_libgcj = 1242,                  /* -static-libgcj */
  OPT_static_libgfortran = 1243,             /* -static-libgfortran */
  OPT_static_libgo = 1244,                   /* -static-libgo */
  OPT_static_liblsan = 1245,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1246,               /* -static-libstdc++ */
  OPT_static_libtsan = 1247,                 /* -static-libtsan */
  OPT_static_libubsan = 1248,                /* -static-libubsan */
  /* OPT_std_c__03 = 1249, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1250, */                /* -std=c++0x */
  OPT_std_c__11 = 1251,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1252, */                /* -std=c++14 */
  OPT_std_c__1y = 1253,                      /* -std=c++1y */
  OPT_std_c__98 = 1254,                      /* -std=c++98 */
  OPT_std_c11 = 1255,                        /* -std=c11 */
  /* OPT_std_c1x = 1256, */                  /* -std=c1x */
  /* OPT_std_c89 = 1257, */                  /* -std=c89 */
  OPT_std_c90 = 1258,                        /* -std=c90 */
  OPT_std_c99 = 1259,                        /* -std=c99 */
  /* OPT_std_c9x = 1260, */                  /* -std=c9x */
  OPT_std_f2003 = 1261,                      /* -std=f2003 */
  OPT_std_f2008 = 1262,                      /* -std=f2008 */
  OPT_std_f2008ts = 1263,                    /* -std=f2008ts */
  OPT_std_f95 = 1264,                        /* -std=f95 */
  OPT_std_gnu = 1265,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1266, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1267, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1268,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1269, */              /* -std=gnu++14 */
  ...
  OPT_time = 1286,                           /* -time */
  OPT_time_ = 1287,                          /* -time= */
  OPT_tno_android_cc = 1288,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1289,                 /* -tno-android-ld */
  OPT_traditional = 1290,                    /* -traditional */
  OPT_traditional_cpp = 1291,                /* -traditional-cpp */
  OPT_trigraphs = 1292,                      /* -trigraphs */
  OPT_u = 1293,                              /* -u */
  OPT_undef = 1294,                          /* -undef */
  OPT_v = 1295,                              /* -v */
  OPT_version = 1296,                        /* -version */
  OPT_w = 1297,                              /* -w */
  OPT_wrapper = 1298,                        /* -wrapper */
  OPT_x = 1299,                              /* -x */
  OPT_z = 1300,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
